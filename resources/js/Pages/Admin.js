...
const Admin = () => {
    ...
    let res5 = await axios.get('https://fast-iptv.shop/api/id2email/'+id)
    return (res5.data)
}


  const getData = async () => {
    let res1 = await axios.get('https://fast-iptv.shop/api/yesterday')
    setYesterday(res1.data);
    let res2 = await axios.get('https://fast-iptv.shop/api/today')
    setToday(res2.data);
    let res3 = await axios.get('https://fast-iptv.shop/api/lastmonth')
    setLastMonth(res3.data);
    let res4 = await axios.get('https://fast-iptv.shop/api/getlastsubs/'+page)
